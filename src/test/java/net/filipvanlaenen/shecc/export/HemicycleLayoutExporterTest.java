...
public class HemicycleLayoutExporterTest {
    ...
    void svgExportForThreeSeatsInADefaultHemicycleLayout() {
        ...
        String expected = "<svg height=\"788.15216\" viewBox=\"-0.316178 -1.05 0.632355 0.788152\" width=\"632.355228\""
                ...
                + "  <circle cx=\"0\" cy=\"-0.444444\" fill=\"grey\" r=\"0.1\"/>\n"
                + "  <circle cx=\"0\" cy=\"-0.666667\" fill=\"grey\" r=\"0.1\"/>\n"
                + "  <circle cx=\"0\" cy=\"-0.888889\" fill=\"grey\" r=\"0.1\"/>\n"
    ...
    void svgExportForThreeSeatsWithAnAngleLessThanPi() {
        ...
        String actual = exporter.export(layout);
        String expected =
                "<svg height=\"1431.395636\" viewBox=\"-1.051915 -1.05 2.103831 1.431396\" width=\"2103.830599\""
                        + " xmlns=\"http://www.w3.org/2000/svg\">\n"
                        + "  <circle cx=\"-0.666655\" cy=\"-0.003864\" fill=\"grey\" r=\"0.3\"/>\n"
                        + "  <circle cx=\"0\" cy=\"-0.666667\" fill=\"grey\" r=\"0.3\"/>\n"
                        + "  <circle cx=\"0.666655\" cy=\"-0.003864\" fill=\"grey\" r=\"0.3\"/>\n"
                        + "  <text fill=\"black\" font-size=\"0.021038\" text-anchor=\"end\""
                        + " transform=\"rotate(270 1.051915,-1.05)\" x=\"1.041396\" y=\"-1.060519\">Chart produced"
                        + " using SHecC</text>\n" + "</svg>";
        assertEquals(expected, actual);
    }
    ...
    void svgExportForThreeSeatsWithAnAngleGreaterThanPi() {
        ...
        HemicycleLayoutExporter exporter = new HemicycleLayoutExporter();
        String actual = exporter.export(layout);
        String expected = "<svg height=\"1437.534049\" viewBox=\"-1.05 -1.05 2.1 1.437534\" width=\"2100\""
                + " xmlns=\"http://www.w3.org/2000/svg\">\n"
                + "  <circle cx=\"-0.666661\" cy=\"0.002802\" fill=\"grey\" r=\"0.3\"/>\n"
                + "  <circle cx=\"0\" cy=\"-0.666667\" fill=\"grey\" r=\"0.3\"/>\n"
                + "  <circle cx=\"0.666661\" cy=\"0.002802\" fill=\"grey\" r=\"0.3\"/>\n"
                + "  <text fill=\"black\" font-size=\"0.021\" text-anchor=\"end\" transform=\"rotate(270 1.05,-1.05)\""
                + " x=\"1.0395\" y=\"-1.0605\">Chart produced using SHecC</text>\n" + "</svg>";
        assertEquals(expected, actual);
    }
}
