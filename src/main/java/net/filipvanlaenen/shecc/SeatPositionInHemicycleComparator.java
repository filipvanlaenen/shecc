...
/**
 * Class to compare two seat positions in a hemicycle. A seat position comes
 * before another one if its angle is less than the other's angle measures from
 * 3π/2 (the south), and if both have equal angles, if its radius is less than
 * the other's radius.
 */
class SeatPositionInHemicycleComparator implements Comparator<SeatPosition> {
    ...
    /**
     * Calculates the distance of an angle from 3π/2 (the south), clockwise. For
     * angles α less than 3π/2, this is 3π/2 - α. For angles α greater than 3π/2,
     * this is 7π/2 - α.
     *
     * @param angle
     *            The angle.
    ...
    /**
     * Compares the angles of two seat positions, both measured from 3π/2 (the
     * south).
     *
     * @param seatPosition1
     ...
     * @return The result of comparing the angle of the first seat position to the
     *         radius of the second seat position.
     */
     ...
     * @param seatPosition2
     *            The second seat position.
     * @return The result of comparing the radius of the first seat position to the
     *         radius of the second seat position.
     */
    ...
    /**
     * Verifies whether two seat positions have angles that are practically equal.
     * Practically equal means that their difference is less than the angle delta.
     *
     * @param seatPosition1
     *            The first seat position.
     * @param seatPosition2
